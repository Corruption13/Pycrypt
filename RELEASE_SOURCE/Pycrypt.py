...
class Text(Screen):
    ...
    def enc(self, mode=1):
        ...
        if len(self.key.text) > 2:
            ...
            if mode == 1:
                try:
                    self.decr.text = obj.encrypt_string.encode('utf-8').decode('utf-8')
                except:
                    self.decr.text = obj.encrypt_string.encode().decode('Latin-1')
            elif mode == 2:
    ...
    def dec(self, mode=1):
        ...
        if len(self.key.text) > 2:
            ...
            if mode == 1:
                try:
                    self.encr.text = obj.decrypt_string.encode('utf-8').decode('utf-8')
                except:
